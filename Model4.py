...
def Train_Model(Path):
    ...
    with open('Model4_SVC_Report.json', 'w', encoding='utf-8') as f:
...
def Predict(q):
    ...
    # Opening JSON file
    f = open(path+'/Model4_SVC_Report.json') 
    report = json.load(f)
